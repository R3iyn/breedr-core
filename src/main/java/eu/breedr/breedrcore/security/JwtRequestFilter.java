...
import static eu.breedr.breedrcore.utils.Constants.AUTHORIZATION_HEADER;
import static eu.breedr.breedrcore.utils.Constants.AUTHORIZATION_HEADER_BEARER;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(final HttpServletRequest httpServletRequest, final HttpServletResponse httpServletResponse, final FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith(AUTHORIZATION_HEADER_BEARER)) {
            jwt = authorizationHeader.substring(AUTHORIZATION_HEADER_BEARER.length());
    ...
    @Autowired
    public void setJwtUtil(final JwtUtil jwtUtil) {
